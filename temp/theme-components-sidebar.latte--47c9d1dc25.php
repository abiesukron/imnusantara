...
/** source: C:\Project\tagline\templates\theme\components\sidebar.latte */
final class Template_47c9d1dc25 extends Latte\Runtime\Template
{
	public const Source = 'C:\\Project\\tagline\\templates\\theme\\components\\sidebar.latte';
...
';
		...
		echo "\n";
		if ($grupid_sesi == 1) /* line 90 */ {
			echo '                <li><label>Seting</label></li>
                <li class=\'';
			if ($current == 'users') /* line 92 */ {
				echo 'active';
			}
			echo '\'>
                    <a data-toggle="menu" href="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url)) /* line 93 */;
			echo LR\Filters::escapeHtmlAttr(\AbieSoft\AsetCode\Utilities\Config::envReader('ADMIN_PREFIX')) /* line 93 */;
			echo '/users">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
';
    ...
    <div class="footer">
        <div class="tanggal">';
		echo LR\Filters::escapeHtmlText(\AbieSoft\AsetCode\Utilities\Tanggal::simpel()) /* line 113 */;
		echo '</div>
        <div class="btn-grup-icon">
';
		if ($namagrup_sesi == 'Administrator') /* line 115 */ {
			echo '                <button data-toggle="menu" onClick=\'window.location.href=this.dataset.link\' data-link="';
			echo LR\Filters::escapeHtmlAttr($url) /* line 116 */;
			echo LR\Filters::escapeHtmlAttr(\AbieSoft\AsetCode\Utilities\Config::envReader('ADMIN_PREFIX')) /* line 116 */;
			echo '/users/read/@';
			echo LR\Filters::escapeHtmlAttr(explode('@', $email_sesi)[0]) /* line 116 */;
			echo '/seting">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
';
		...
		echo LR\Filters::escapeHtmlAttr($nama_sesi) /* line 122 */;
		echo '">
