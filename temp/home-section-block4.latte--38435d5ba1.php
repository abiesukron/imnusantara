...
/** source: D:\Sukron\Project\php\imnusantara\templates\website\home\section\block4.latte */
final class Template_38435d5ba1 extends Latte\Runtime\Template
{
	public const Source = 'D:\\Sukron\\Project\\php\\imnusantara\\templates\\website\\home\\section\\block4.latte';
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Institusi</label>
            ...
            <div class="col-4">
                <div class="card">
                    <div class="banner-auto">
                        <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url)) /* line 151 */;
		echo 'assets/images/website/banner_3.jpg">
                    </div>
                    <div class="banner-auto">
                        <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url)) /* line 154 */;
		echo 'assets/images/website/banner_4.jpg">
                    </div>
                </div>
            </div>
