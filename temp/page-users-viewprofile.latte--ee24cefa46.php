...
final class Template_ee24cefa46 extends Latte\Runtime\Template
{
...
<form method="post" id="formInput" name="formInput">
    <div class="page">
		...
		echo '</div>
                                <button type="button" title="Kirim Email" onClick=\'window.location.href=this.dataset.link\' data-link=\'mailto:';
