...
/** source: D:\Sukron\Project\tagline\vendor\abiesoft\Http/../../../templates/page/users/edit.latte */
final class Template_04898ed823 extends Latte\Runtime\Template
{
	public const Source = 'D:\\Sukron\\Project\\tagline\\vendor\\abiesoft\\Http/../../../templates/page/users/edit.latte';
                ...
                <div class="card">
                    ...
                    <div class="card-form">
                            <div class="form-grup">
                                ...
                                <input class="form-control" id="nama" name="nama" placeholder="Masukan nama user" autocomplete="off" value="';
		echo LR\Filters::escapeHtmlAttr($namauser) /* line 35 */;
		echo '">
                            </div>
                            <div class="form-grup">
                                <label for="email">Email</label>
                                <input class="form-control" id="email" name="email" placeholder="Contoh: email@email.com" value="';
		...
		echo '">
                            ...
                            <div class="form-grup">
                                ...
                                <select class="form-control" id="grupid" name="grupid">
                                    <option value="';
		echo LR\Filters::escapeHtmlAttr($idgrup) /* line 44 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($namagrup) /* line 44 */;
		echo '</option>
';
...
';
		...
		echo LR\Filters::escapeHtmlAttr($id) /* line 61 */;
		echo '">
