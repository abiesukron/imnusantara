...
/** source: E:\Sukron\Backup 9 Oktober 2024\Sukron\Project\tagline\templates\website\home\section\block5.latte */
final class Template_06c916b901 extends Latte\Runtime\Template
{
	public const Source = 'E:\\Sukron\\Backup 9 Oktober 2024\\Sukron\\Project\\tagline\\templates\\website\\home\\section\\block5.latte';
    ...
    <div class="container">
		...
		echo 'berita/index/lintas-berita">
                    ...
                    <div class="card-list" id="lintasberita">
                        <a class="item-list">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-biru">Olah Raga</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
		echo LR\Filters::escapeHtmlAttr($url) /* line 78 */;
		echo 'berita/index/olah-raga">
                            <span>Index</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                <path fill-rule="evenodd" d="M12.97 3.97a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 1 1-1.06-1.06l6.22-6.22H3a.75.75 0 0 1 0-1.5h16.19l-6.22-6.22a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd"></path>
                            </svg>
                    ...
                    <div class="card-list" id="olahraga">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge right-custom">
                        <label class="badge-orange">Internasional</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
		echo LR\Filters::escapeHtmlAttr($url) /* line 150 */;
		echo 'berita/index/internasional">
                            <span>Index</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                <path fill-rule="evenodd" d="M12.97 3.97a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 1 1-1.06-1.06l6.22-6.22H3a.75.75 0 0 1 0-1.5h16.19l-6.22-6.22a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd"></path>
                            </svg>
                    ...
                    <div class="card-list right-custom" id="internasional">
                        <a class="item-list">
                            <div class="cover-list">
                                <div class="shimmer" style="width: 100%; height: 100%; background: #eee;"></div>
                            </div>
            ...
            <div class="col-12 left-custom">
                <div class="card">
                    ...
                    <div class="banner-998-200">
                        <img src="https://tagline.id/assets/storage/X4vgs6GXdDiD/images/11052023231418_proteksi_diri.jpeg">
                    </div>

                    <div class="white-page row right-custom">
                        <div class="card-badge x-custom">
                            <label class="badge-dark">Edukasi</label>
                            <button onClick="window.location.href=this.dataset.link" data-link="';
		echo LR\Filters::escapeHtmlAttr($url) /* line 231 */;
