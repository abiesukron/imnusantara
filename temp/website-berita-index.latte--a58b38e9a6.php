...
/** source: E:\Sukron\Backup 9 Oktober 2024\Sukron\Project\tagline\vendor\abiesoft\Http/../../../templates/website/berita/index.latte */
final class Template_a58b38e9a6 extends Latte\Runtime\Template
{
	public const Source = 'E:\\Sukron\\Backup 9 Oktober 2024\\Sukron\\Project\\tagline\\vendor\\abiesoft\\Http/../../../templates/website/berita/index.latte';
...
';
    ...
    <div class="container">
		...
		echo 'berita/index/bisnis">Bisnis</a></li>
                        <li ';
		if ($kategori == 'Lintasberita') /* line 21 */ {
			echo ' class=\'active\'; ';
		}
		echo '><a href="';
...
fetch(Baseurl + "api/berita/index_"+activePage.dataset.konten.toLowerCase().replaceAll(" ",""), {
    ...
    if(result.message == "OK"){
        ...
        for(let i=0; i<result.data.length; i++){
            konten += `
                <a href="';
		echo LR\Filters::escapeJs($url) /* line 187 */;
		echo 'berita/read/`+result.data[i].slug+`" class="item-list">
                    <div class="cover-list">
