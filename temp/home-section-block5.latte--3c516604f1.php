...
/** source: D:\Sukron\Project\php\imnusantara\templates\website\home\section\block5.latte */
final class Template_3c516604f1 extends Latte\Runtime\Template
{
	public const Source = 'D:\\Sukron\\Project\\php\\imnusantara\\templates\\website\\home\\section\\block5.latte';
    ...
    <div class="container">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Lintas Berita</label>
		...
		echo 'berita/index/lintas-berita">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Olah Raga</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge right-custom">
                        <label class="badge-label">Internasional</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
            ...
            <div class="col-12 left-custom">
                <div class="card">
                    ...
                    <div class="banner-998-200">
                        <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url)) /* line 225 */;
