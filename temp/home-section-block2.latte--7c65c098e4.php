...
/** source: D:\Sukron\Project\php\imnusantara\templates\website\home\section\block2.latte */
final class Template_7c65c098e4 extends Latte\Runtime\Template
{
	public const Source = 'D:\\Sukron\\Project\\php\\imnusantara\\templates\\website\\home\\section\\block2.latte';
    ...
    <div class="container">
		...
		echo 'assets/images/website/banner_2.jpg">
                    </div>
                </div> 
            </div>
            <div class="col-4">
                <div class="card left-custom">
                    <div class="card-badge">
                        <label class="badge-label">Nasional</label>
		...
		echo 'berita/index/nasional">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Populer</label>
                    </div>
                    <div class=\'card-populer\' id=\'populer\'></div>
                </div>
            </div>
            ...
            <div class="col-12 left-custom">
                <div class="card">
                    ...
                    <div class="white-page row right-custom" id=\'yotubechannel\'>
                        <div class="card-badge x-custom">
                            <label class="badge-label">Chanel Youtube <span class=\'imnusantara\'>IM Nusantara Official</span></label>
                            <button onClick="window.location.href=this.dataset.link" data-link="https://www.youtube.com/@im_nusantaraofficial">
