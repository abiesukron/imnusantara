...
/** source: D:\Sukron\Project\php\imnusantara\templates\website\home\section\block3.latte */
final class Template_39f96c7aa9 extends Latte\Runtime\Template
{
	public const Source = 'D:\\Sukron\\Project\\php\\imnusantara\\templates\\website\\home\\section\\block3.latte';
    ...
    <div class="container">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Politik</label>
		...
		echo 'berita/index/politik">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Bisnis</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
		...
		echo 'berita/index/bisnis">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-badge">
                        <label class="badge-label">Kata Warga</label>
                        <button onClick="window.location.href=this.dataset.link" data-link="';
